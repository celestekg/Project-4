//Celeste Going
//Project 4
/*This program calculates how many people can ride
an elevator with a weight limit of 1,100 lbs. The
program lists the names and weight of the people
who want to ride and determines who will fit.
It then arranges the people in descending sequence
by weight, and then ascending sequence by name.
Finally, the program determines which method
allows for the most people to ride the elevator.*/
